...
#include "../cipher/PH_Cipher/PH_Member.h"
//#include "../cipher/XH_Cipher/XH_Member.h"
...
class Conn{
    public:
        ...
        void closeFd();
        PH_Member& get_cipher_member();                             //获取其加密参数内容
    ...
    private:
        ...
        PH_Member cipher_member_;       //加密算法信息
        //XH_Member cipher_member_;
