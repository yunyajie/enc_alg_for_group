...
object_server=server/epoller.o server/main.o server/server.o conn/conn.o timer/heaptimer.o cipher/PH_Cipher/PH_Cipher.o cipher/PH_Cipher/PH_Member.o pool/sqlconnpool.o
